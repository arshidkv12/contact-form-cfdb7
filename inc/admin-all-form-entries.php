...
*
*/
class CFDB7_All_Form_Entries
{
	
	
	/**
     * Constructor will create the sub-menu item
    */
    ...
    {		
        ...
        add_submenu_page('cfdb7-list.php', 'All Form Entries', 'All Form Entries', $cfdb7_cap, 'cfdb7-all-form-entries',  array($this, 'admin_all_form_entries_page') );
    ...
    */
    public function admin_all_form_entries_page()
    {
        $this->all_form_entries_page();
    }
	
	
    /**
     * Display the form entries table
     *
     * @return Void
    */
    public function all_form_entries_page(){
        $ListTable = new CFDB7_List_All_Table();
        $ListTable->prepare_items();
        ?>
            <div class="wrap">
                <div id="icon-users" class="icon32"></div>
                <h2>All Form Entries</h2>
...
//add menu page
$all_forms_menupage = new CFDB7_All_Form_Entries;
 ...
 */
class CFDB7_List_All_Table extends WP_List_Table
{
    ...
    public function prepare_items()
    {
        ...
        if ( ! empty($search) ) {
            ...
            $totalItems  = $cfdb->get_var("SELECT COUNT(*) FROM $table_name");
        }
     ...
     * For all entries columns may differ by form so we'll only list form name and date of entry
     *
     * @return Array
     */
    public function get_columns()
    {
        ...
        $results       = $cfdb->get_results( "
            ...
            ORDER BY form_id DESC LIMIT 1", OBJECT 
        );
        ...
        if( !empty($first_row) ){
            ...
            $columns['form-name'] = 'Form Name';
			$columns['form-entry-id'] = 'Entry ID';
    ...
    private function table_data()
    {
        ...
        foreach ( $results as $result ) {
			...
			$form_values['form-name'] = get_the_title( $fid );
			$form_values['form-entry-id'] = $result->form_id;
